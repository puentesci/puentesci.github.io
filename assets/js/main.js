    ...
    applyLanguage(language) {
        ...
        const translations = {
            en: {
                ...
                'stat-growth': 'Growth in Emerging Tech Market',
                'stat-savings': 'Max Savings with Refurbished',
                'stat-launch': 'Year We Launched',
                'get-in-touch': 'Get In Touch',
                'contact-email-label': 'Email',
                'contact-phone-label': 'Phone',
                'contact-markets-label': 'Reach Emerging Markets',
                'contact-markets-note': 'Your inventory can reach further',
                'contact-info-title': 'Contact Information',
                'contact-info-desc': 'We\'re here to help you navigate the complexities of international trade. Reach out to us through any of the following channels.',
                'contact-email-note': 'General inquiries and support',
                'contact-phone-note': 'Monday - Friday, 9:00 AM - 6:00 PM EST',
                'contact-address-label': 'Address',
                'contact-address-note': 'Headquarters',
                'contact-hours-label': 'Business Hours',
                'contact-hours-weekdays': 'Monday - Friday: 9:00 AM - 5:00 PM EST',
                'contact-hours-sat': 'Saturday: Case by case basis',
                'contact-hours-sun': 'Sunday: Closed',
                'contact-duns-label': 'D-U-N-S Number',
                'contact-duns-note': 'Verify us with Dun & Bradstreet',
                'follow-us': 'Follow Us',
                'contact-form-title': 'Send Us a Message',
                'contact-form-desc': 'Fill out the form below and our team will get back to you promptly.',
                'footer-tagline': 'Giving used equipment a second life abroad',
                'footer-privacy': 'Privacy Policy',
                'footer-terms': 'Terms of Service',
                'footer-copyright': '© 2025 Puente Scientific. All rights reserved.'
            },
            es: {
                'nav-home': 'Inicio',
                'nav-about': 'Acerca de',
                ...
                'product-prep-title': 'Kits de Preparación de Muestras',
                'product-prep-desc': 'Filtros, viales, tapas y accesorios para la preparación de muestras de HPLC. Consumibles en stock a precios de economía reacondicionada.',
                'product-columns-title': 'Columnas HPLC',
                'product-columns-desc': 'Columnas analíticas usadas y reacondicionadas, probadas antes del envío. Principales fabricantes disponibles bajo pedido.',
                'product-lamps-title': 'Lámparas de Deuterio',
                'product-lamps-desc': 'Lámparas de repuesto D2 para detectores UV. Conseguimos números de parte difíciles de encontrar para instrumentos descontinuados.',
                'request-quote': 'Solicitar cotización',
                'request-quote-alt': 'Solicitar cotización',
                'sourcing-title': '¿Buscas algo específico?',
                'sourcing-desc': 'Conseguimos piezas difíciles de encontrar y equipos descontinuados en todo el mundo. Dinos el fabricante y el número de parte — si existe, normalmente podemos encontrarlo.',
                'surplus-title': '¿Tienes equipo de laboratorio excedente?',
                'surplus-desc': 'Compramos y aceptamos en consignación sistemas HPLC usados y piezas.',
                'surplus-cta': 'Obtener una oferta',
                'payment-note': 'Aceptamos pagos con tarjeta (Visa, Mastercard, Amex vía Stripe) y transferencia bancaria. Pedidos internacionales bienvenidos.',
                'rfq-equipment-label': 'Equipo / pieza necesaria',
                'rfq-manufacturer-label': 'Fabricante y modelo',
                'rfq-quantity-label': 'Cantidad',
                'rfq-country-label': 'País de destino',
                'rfq-timeline-label': 'Plazo',
                'rfq-timeline-select': 'Selecciona un plazo (opcional)',
                'rfq-timeline-asap': 'Lo antes posible',
                'rfq-timeline-30': 'Dentro de 30 días',
                'rfq-timeline-exploring': 'Solo explorando',
                'stat-growth': 'Crecimiento del Mercado de Tecnología Emergente',
                'stat-savings': 'Ahorro Máximo con Reacondicionados',
                'stat-launch': 'Año de Nuestro Lanzamiento',
                'get-in-touch': 'Ponte en Contacto',
                'contact-email-label': 'Correo Electrónico',
                'contact-phone-label': 'Teléfono',
                'contact-markets-label': 'Llega a Mercados Emergentes',
                'contact-markets-note': 'Tu inventario puede llegar más lejos',
                'contact-info-title': 'Información de Contacto',
                'contact-info-desc': 'Estamos aquí para ayudarte a navegar las complejidades del comercio internacional. Contáctanos a través de cualquiera de los siguientes canales.',
                'contact-email-note': 'Consultas generales y soporte',
                'contact-phone-note': 'Lunes - Viernes, 9:00 AM - 6:00 PM EST',
                'contact-address-label': 'Dirección',
                'contact-address-note': 'Sede central',
                'contact-hours-label': 'Horario de Atención',
                'contact-hours-weekdays': 'Lunes - Viernes: 9:00 AM - 5:00 PM EST',
                'contact-hours-sat': 'Sábado: Según el caso',
                'contact-hours-sun': 'Domingo: Cerrado',
                'contact-duns-label': 'Número D-U-N-S',
                'contact-duns-note': 'Verifícanos con Dun & Bradstreet',
                'follow-us': 'Síguenos',
                'contact-form-title': 'Envíanos un Mensaje',
                'contact-form-desc': 'Completa el formulario y nuestro equipo te responderá a la brevedad.',
                'footer-tagline': 'Dando una segunda vida al equipo usado en el extranjero',
                'footer-privacy': 'Política de Privacidad',
                'footer-terms': 'Términos de Servicio',
                'footer-copyright': '© 2025 Puente Scientific. Todos los derechos reservados.'
            },
            zh: {
                'nav-home': '首页',
                'nav-about': '关于我们',
